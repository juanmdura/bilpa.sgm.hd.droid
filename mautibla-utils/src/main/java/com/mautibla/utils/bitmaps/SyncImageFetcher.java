 ...
 */
public class SyncImageFetcher extends SyncImageResizer {
     ...
     * @param imageHeight
     */
    public SyncImageFetcher(Context context, int imageWidth, int imageHeight) {
     ...
     * @param imageSize
     */
    public SyncImageFetcher(Context context, int imageSize) {
...
//            Toast.makeText(context, "No network connection found.", Toast.LENGTH_LONG).show();
    ...
    public static File downloadBitmap(Context context, String urlString) {
        ...
        if (cache == null) {
        	cacheFile = new File(DiskLruCache.createFilePath(cacheDir, urlString));
        } else {
