...
public class DiskLruCache {
    ...
    public static DiskLruCache openCache(Context context, File cacheDir, long maxByteSize) {
        ...
        } else if ( Utils.getUsableSpace(cacheDir) < maxByteSize) {
            return new DiskLruCache(cacheDir, Utils.getUsableSpace(cacheDir));
        }
     ...
     * {@link com.mautibla.utils.bitmaps.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra checks before
     ...
     * call {@link com.mautibla.utils.bitmaps.DiskLruCache#clearCache(android.content.Context, String)} or {@link com.mautibla.utils.bitmaps.DiskLruCache#clearCache()}
     * instead.
     *
    ...
    /**
     * Writes a bitmap to a file. Call {@link com.mautibla.utils.bitmaps.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)}
