...
public class CPendientesAdapter extends BaseAdapter<Pendiente> {
    ...
    public CPendientesAdapter(Context context, List<Pendiente> items) {
    ...
    protected View newView(int position, ViewGroup parent, Pendiente item) {
        View v = mInflater.inflate(R.layout.row_cpendientes_list, parent, false);
