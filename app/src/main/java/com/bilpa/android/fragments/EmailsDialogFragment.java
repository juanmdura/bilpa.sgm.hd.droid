...
public class EmailsDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public interface OnFinishVistaListener {
        public void onFinishVisita();
    }

    private OnFinishVistaListener mOnFinishVistaListener;

    public static EmailsDialogFragment newInstance(Long visitaId, List<String> preloadEmails, OnFinishVistaListener onFinishVistaListener) {
        EmailsDialogFragment frag = new EmailsDialogFragment();
        frag.mVisitaId = visitaId;
        frag.mPreloadEmails = preloadEmails;
        frag.mOnFinishVistaListener = onFinishVistaListener;
        return frag;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        MaterialDialog.Builder builder = new MaterialDialog.Builder(getActivity())
                .title(getString(R.string.visita_emails_title))
    ...
    private void doFinishVisita() {
        ...
        FinalizarVisitaAction.Builder b = new FinalizarVisitaAction.Builder();
        b.visitaId(mVisitaId).mails(getEmails());
        ApiService.finishVisita(b, new AsyncCallback<BaseResult>(getActivity()) {
            @Override
            protected void onSuccess(BaseResult result) {
                // Go Home. Need reload visitas.
                if (mOnFinishVistaListener != null) {
                    mOnFinishVistaListener.onFinishVisita();
                }
            }
        });
    }
