...
public class SaveChequeoGenericoAction extends PreventivosAction<BaseResult> {

    private Map<String, String> params;
    private String body;
    private final Gson gson;

    public SaveChequeoGenericoAction() {
    ...
    public static class Builder {
        ...
        public SaveChequeoGenericoAction create() {
            SaveChequeoGenericoAction s = new SaveChequeoGenericoAction();
            s.createBody(this);
            return s;
        }
